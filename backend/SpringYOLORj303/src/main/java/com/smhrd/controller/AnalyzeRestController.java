...
public class AnalyzeRestController {
      ...
      public void normalWorkloadInsert (Workload normalWorkload, HttpSession session) {
         ...
         memberDto.setIDENTIFI_ID(loginMem.getIDENTIFI_ID());
         
         // Workload테이블에 MEMBER_ID가 필요함.
         normalWorkload.setMEMBER_ID(memberDto.getIDENTIFI_ID());
      ...
      public void detectionInsert (Detection detec, HttpSession session) {
         ...
         detec.setIDENTIFI_ID(memberDto.getIDENTIFI_ID());
         workloadDto.setMEMBER_ID(memberDto.getIDENTIFI_ID());
      ...
      public List<Detection> detectionCombinationType(HttpSession session){
         ...
         List<Detection> CombinationTypeAll = mapper.detectionCombinationType(memberDto.getIDENTIFI_ID());
